<nav
    ...
    <div class="container-fluid">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="javascript:;" data-bs-toggle="{{ (Route::is('students.tests','students.advancedTrajectory')) ? '' : 'modal'}}" data-bs-target="#modal-warning-3">
