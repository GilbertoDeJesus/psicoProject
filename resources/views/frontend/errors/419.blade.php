                        ...
                        <div class="card">
                            ...
                            <div class="card-body px-lg-6 py-lg-4 text-center">
                                <div class="text-center text-muted mb-4">
                                    <h2 class="h1">419</h2>
                                    <p class="text-lead h5">La sesión ha caducado.</p>
                                </div>
                                <div class="row gx-2 gx-sm-3">

                                    <div class="text-center">
                                        <p class="text-lead t">Su sesión ha caducado, por favor inicie sesión de nuevo.
                                        </p>
                                    </div>
                                    <div class="text-center">
                                        <a href="{{ route('admin.sign-up') }}" class="btn bg-gradient-dark btn-lg w-100 mt-4 text-white">Regresar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
