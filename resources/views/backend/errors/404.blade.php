                        ...
                        <div class="card">
                            <div class="card-header p-0 mx-auto position-relative z-index-1">
                                <a href="javascript:;" class="d-block">
                                  <img src="{{ url('backend/images/error4041.png') }}" class="img-fluid border-radius-lg max-height-300">
                                </a>
                              </div>
                            <div class="card-body px-lg-6 py-lg-4 text-center">
                                <div class="text-center text-muted mb-4">
                                    <h2 class="h1">404</h2>
                                    <p class="text-lead h5">Oops. La página que buscaba no está aquí.</p>
                                </div>
                                <div class="row gx-2 gx-sm-3">

                                    <div class="text-center">
                                        <p class="text-lead t"> Es posible que haya escrito mal la dirección o que la página se haya movido.
                                        </p>
                                    </div>
                                    <div class="text-center">
