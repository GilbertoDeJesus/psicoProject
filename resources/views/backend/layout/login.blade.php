                    ...
                    <div class="col-xl-4 col-md-7">
                        <div class="card">
                            <div class="card-body px-lg-5 py-lg-5 text-center">
                                <div class="info mb-4">
                                    <div
                                        class="icon icon-shape icon-xl rounded-circle bg-gradient-dark-green shadow text-center py-3 mx-auto">
                                        <img src="{{ url('frontend/assets/img/uttlogo.svg') }}" class="mt-3 h-100"  style="max-height: 38px;">
                                        
                                    </div>
                                </div>
                                <div class="text-center text-muted mb-4">
                                    <h2>¡Bienvenido!</h2>
                                    <p class="text-lead t">Ingresa tus datos para acceder.</p>
                                </div>
                                <div class="row gx-2 gx-sm-3">
                                    <form role="form text-left" method="POST" action="{{ route('admin.log-in') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                                class="btn bg-gradient-dark btn-lg w-100 mt-4 text-white">Iniciar
                                                sesión</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="text-center">
                                    <span class="text-muted text-sm">UTTehuacan {{ now()->isoFormat('YYYY') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
