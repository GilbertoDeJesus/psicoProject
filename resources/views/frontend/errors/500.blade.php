                        ...
                        <div class="card">
                            <div class="card-header p-0 mx-auto position-relative z-index-1">
                                <a href="javascript:;" class="d-block">
                                  <img src="{{ url('backend/images/error500.png') }}" class="img-fluid border-radius-lg max-height-300">
                                </a>
                              </div>
                            <div class="card-body px-lg-6 py-lg-4 text-center">
                                <div class="text-center text-muted mb-4">
                                    <h2 class="h1">500</h2>
                                    <p class="text-lead h5">Bueno, esto es inesperado...</p>
                                </div>
                                <div class="row gx-2 gx-sm-3">

                                    <div class="text-center">
                                        <p class="text-lead t"> Se ha producido un error y estamos trabajando para solucionarlo. Estaremos listos y funcionando en breve.
                                        </p>
                                        <p>
                                            Si necesita ayuda inmediata de nuestro equipo de atención al cliente pongase en contacto con el administrador. ¡Gracias por su paciencia!
                                        </p>
                                    </div>
                                    <div class="text-center">
