                    ...
                    <div id="middle-wizard">
                        ...
                        <div class="step">
                            ...
                            <div class="form-group">
                                <input type="text" name="question_{{ $questions->id }}" class="form-control required"
                                    placeholder="">
                            </div>
                            @else
                            ...
                            <div class="form-group">
                                <label class="container_radio version_2">{{ $ans->answer }}
                                    <input type="radio" name="question_{{ $questions->id }}" value="{{ $ans->value }}"
                                        class="required">
                            ...
                            <div class="form-group">
                                <label class="container_check version_2">{{ $ans->answer }}
                                    <input type="checkbox" name="question_{{ $questions->id }}[]" value="{{ $ans->id }}"
                                        class="required">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
